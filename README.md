...
It should be noted that these results have been obtained without any tricks with data augmentation or CNN structure development. Certainly, results would be much better if more images were in the train set or some efficient layers (as BatchNorm or Dropout) were used. Anyway, even such straightforward approach with so simple CNN structure has shown pretty nice results.
